	  ...
	  <div class="content_box">
		<div class="container">
				...
				<div class="col-md-3">
					<div class="menu_box">
				     ...
				     <div class="side_banner">
					   <div class="banner_img"><img src="<c:url value="/resources/web/images/pic9.jpg"/>" class="img-responsive" alt=""/></div>
			   ...
			   <div class="singel_right">
			     <div class="labout span_1_of_a1">
				   <div class="flexslider">
					 <ul class="slides">
						<li data-thumb="<c:url value="/resources/web/images/chest1.jpg"/>">
							<img src="<c:url value="/resources/web/images/chest1.jpg" />">
						</li>
						<li data-thumb="<c:url value="/resources/web/images/chest2.jpg"/>">
							<img src="<c:url value="/resources/web/images/chest2.jpg" />">
						</li>
						<li data-thumb="<c:url value="/resources/web/images/chest3.jpg"/>">
							<img src="<c:url value="/resources/web/images/chest3.jpg" />">
						</li>
		   ...
		   <div class="sap_tabs">	
					 ...
					 <h3 class="like">Never Give up</h3>        			
				     <ul id="flexiselDemo3">
						<li><img src="<c:url value="/resources/web/images/pic11.jpg"/>" class="img-responsive" /><div class="grid-flex"><a href="#">Syenergy 2mm</a><p>Rs 850</p></div></li>
						<li><img src="<c:url value="/resources/web/images/pic10.jpg"/>"class="img-responsive" /><div class="grid-flex"><a href="#">Surf Yoke</a><p>Rs 1050</p></div></li>
						<li><img src="<c:url value="/resources/web/images/pic9.jpg"/>"class="img-responsive" /><div class="grid-flex"><a href="#">Salty Daiz</a><p>Rs 990</p></div></li>
						<li><img src="<c:url value="/resources/web/images/pic8.jpg"/>" class="img-responsive" /><div class="grid-flex"><a href="#">Cheeky Zane</a><p>Rs 850</p></div></li>
						<li><img src="<c:url value="/resources/web/images/pic7.jpg"/>" class="img-responsive" /><div class="grid-flex"><a href="#">Synergy</a><p>Rs 870</p></div></li>
				     </ul>
				    <script type="text/javascript">
...
<!-- FlexSlider -->
  <script defer src="<c:url value="/resources/web/js/jquery.flexslider.js"/>"></script>
<link rel="stylesheet" href="<c:url value="/resources/web/css/flexslider.css"/>" type="text/css" media="screen" />
