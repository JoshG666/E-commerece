...
<!-- Custom Theme files -->
<link href="<c:url value="/resources/web/css/Style1.css"/>" rel="stylesheet" type="text/css" />
<!-- Custom Theme files -->
<!--webfont-->
<link
		...
		<div class="container">
			<div class="header-top">
				...
				<div class="banner_center">
					...
					<p><br>Shape E-cart aims at providing people with the best gym equipments. It has been rated as the most used application
					worldwide since 2002. </p>
					<a href="index" class="banner_btn">back</a>
				</div>
				<div class='clearfix'></div>
